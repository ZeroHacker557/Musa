...
export const uz = {
  ...
  'checkout.confirmTitle': 'Manzilingizni tasdiqlaysizmi?',
  'checkout.confirmSub': 'Buyurtma shu manzilga yetkaziladi',
  'checkout.confirmNoneTitle': 'Yetkazish manzilini qo‘shing',
  'checkout.confirmNoneSub': 'Kuryer sizni topishi uchun joylashuvingizni belgilang',
  'checkout.confirmYes': 'Tasdiqlayman',
  'checkout.confirmAdd': 'Yangi qo‘shish',
  'checkout.confirmOther': 'Yoki boshqa manzilni tanlang',
