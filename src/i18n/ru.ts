...
export const ru: Record<TranslationKey, string> = {
  ...
  'checkout.confirmTitle': 'Подтверждаете адрес?',
  'checkout.confirmSub': 'Заказ будет доставлен по этому адресу',
  'checkout.confirmNoneTitle': 'Добавьте адрес доставки',
  'checkout.confirmNoneSub': 'Отметьте местоположение, чтобы курьер вас нашёл',
  'checkout.confirmYes': 'Подтверждаю',
  'checkout.confirmAdd': 'Добавить новый',
  'checkout.confirmOther': 'Или выберите другой адрес',
